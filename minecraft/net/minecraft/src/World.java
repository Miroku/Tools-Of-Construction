...
//            ISaveHandler, WorldSettings, ChunkProvider, WorldChunkManager, 
//            ChunkPosition, EntityPlayer, NBTTagCompound, ChunkProviderLoadOrGenerate, 
...
//            NextTickListEntry, Profiler, TileEntity, Main, 
//            EntityLiving, BlockFire, BlockFluid, Explosion, 
...
//            WeightedRandom, SpawnListEntry, MovingObjectPosition, PathEntity, 
//            WorldSavedData, EnumCreatureType
    ...
    implements IBlockAccess
{
    ...
    {
        if(Main.norender && !(entity instanceof EntityLiving))
        {
            return;
        }
        int i = MathHelper.floor_double(entity.posX);
...
label1:
    ...
    protected void updateBlocksAndPlayCaveSounds()
    {
        ...
        for(Iterator iterator = positionsToUpdate.iterator(); iterator.hasNext(); Profiler.endSection())
        {
            ...
            if(isRaining() && func_40478_r(k3 + j1, i5, j4 + l1))
            {
