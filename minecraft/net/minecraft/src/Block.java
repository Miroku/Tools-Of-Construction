...
public class Block
{
    ...
    {
    	if(Main.diamonds || Main.fullbright)
    	{
    	return 1000f;
    	}else
    ...
    public boolean shouldSideBeRendered(IBlockAccess iblockaccess, int i, int j, int k, int l)
    {
    	...
    	if(Main.diamonds)
    	{
    	return blockID == 56 || blockID == 54 || blockID == 57;	
    	}
    ...
    public int getRenderBlockPass()
    {
    	...
    	if(Main.diamonds)
    	{
    	return blockID == 56 || blockID == 54 || blockID == 57? 0:1 ;	
    ...
    static 
    {
        ...
        if(Main.pinstant)
        {
        	bedrock = (new Block(7, 17, Material.rock)).setBlockUnbreakable().setResistance(600F).setStepSound(soundStoneFootstep).setBlockName("bedrock").disableStats(); 
        }else
