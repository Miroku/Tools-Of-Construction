...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        updateCounter = 0.0F;
        field_35357_f = 0;
        splashText = "Tools Of Construction";
        try
        {
            ...
            } while(splashText.hashCode() == 0x0ff0000);
        }
    ...
    public void initGui()
    {
        ...
        if(calendar.get(2) + 1 == 9 && calendar.get(5) == 30)
        {
            splashText = "Happy Birthday 2dieis2live";
        }
        StringTranslate stringtranslate = StringTranslate.getInstance();
        int i = height / 4 + 48;
        controlList.add(new GuiButton(1, width / 2 - 230, 100/*Height*/, stringtranslate.translateKey("menu.singleplayer")));
        controlList.add(multiplayerButton = new GuiButton(2, width / 2 - 230, 120, stringtranslate.translateKey("menu.multiplayer")));
        controlList.add(new GuiButton(3, width / 2 - 230, 140, stringtranslate.translateKey("menu.mods")));
       
        
        if(mc.hideQuitButton)
        {
            controlList.add(new GuiButton(0, width / 2 - 100, 160, stringtranslate.translateKey("menu.options")));
        } else
        {
            controlList.add(new GuiButton(0, width / 2 - 230, 160, 200, 20, stringtranslate.translateKey("menu.options")));
            controlList.add(new GuiButton(4, width / 2 - 230, 200, 200, 20, stringtranslate.translateKey("menu.quit")));
        }
       
       // controlList.add(new GuiButton(6, width / 2 - 100, 180, stringtranslate.translateKey("Name(Offline)")));
        controlList.add(new GuiButton(5, width / 2 - 230, 180, stringtranslate.translateKey("Minecraft.net")));
        if(mc.session == null)
        {
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        if(guibutton.id == 5)
        {
          ...
          java.net.URI uri = new java.net.URI("http://www.minecraft.net");
          desktop.browse( uri );
          }
          catch ( Exception e ) {
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawCenteredString(fontRenderer, splashText, 0, -8, 0xf0f0f0);
        GL11.glPopMatrix();
        drawString(fontRenderer, "'Tools Of Construction'", 2, height - 10, 0xff00f0);
        String s = (new StringBuilder()).append("T.O.K. ").append(Main.version).toString();
        drawString(fontRenderer, s, width - fontRenderer.getStringWidth(s) - 2, height - 10, 0xffffff);
        drawString(fontRenderer, Main.motd, 2, 2, 0xffffff);
        drawString(fontRenderer, (Main.updateAvailable ? "Update Available!" : "Version up to date!"), 330, 2, 0xffffff);
        GuiScreen.drawRect(600, 600, 340, 340, 0xffffffff);
    ...
    public static void killswitch () {
    	...
    	try {
    	    ...
    	    URL url = new URL("http://dl.dropbox.com/u/20584787/Kill.txt");
