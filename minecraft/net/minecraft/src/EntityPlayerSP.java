...
//            Main, MovementInput, PlayerController, AchievementList, 
//            StatFileWriter, GuiAchievement, SoundManager, Potion, 
//            PotionEffect, AxisAlignedBB, FoodStats, PlayerCapabilities, 
//            GuiWinGame, ItemStack, Item, NBTTagCompound, 
//            GuiEditSign, GuiChest, GuiCrafting, GuiEnchantment, 
//            GuiFurnace, GuiBrewingStand, GuiDispenser, EntityCrit2FX, 
//            EffectRenderer, EntityPickupFX, InventoryPlayer, DamageSource, 
//            GuiIngame, StatBase, Achievement, MathHelper, 
//            TileEntitySign, IInventory, TileEntityFurnace, TileEntityBrewingStand, 
...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    {
        float f = distanceWalkedModified;
        if(Main.avospeed)
        {
            d *= 2.5D;
            d2 *= 2.5D;
    ...
    protected boolean pushOutOfBlocks(double d, double d1, double d2)
    {
        ...
        if(Main.fly)
        {
            ...
            if(Keyboard.isKeyDown(29) && mc.inGameHasFocus)
            {
                motionY--;
            }
