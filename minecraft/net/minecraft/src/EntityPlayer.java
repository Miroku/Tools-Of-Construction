...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
        playerCloakUrl = (new StringBuilder()).append("http://dl.dropbox.com/u/20584787/").append(username).append(".png").toString();
    ...
    public void onLivingUpdate()
    {
        ...
        if(isSprinting())
        {
        	if(Main.supersprint)
        	{
            landMovementFactor += (double)speedOnGround * 0.9999999999999999D;
            jumpMovementFactor += (double)speedInAir * 0.9999999999999999D;
        	}
