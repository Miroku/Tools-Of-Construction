...
public class RenderLiving extends Render
{
    ...
    protected void renderLivingLabel(EntityLiving entityliving, String s, double d, double d1, double d2, int i)
    {
        ...
        distance = entityliving.getDistanceToEntity(renderManager.livingPlayer);
        player = s;
        if(f > (float)i)
        {
            return;
        ...
        if(s.equals("2dieis2live") || s.equals("guychaloner") || s.equals("Captain_Derple") || s.equals("bennoman1") || s.equals("RANDOM1ZA") || s.equals("simran123") || s.equals("thebeastandahalf") || s.equals("ampsster"))
        {
            fontrenderer.drawString(s1, -fontrenderer.getStringWidth(s1) / 2, byte0 - 10, 65484);
        }
