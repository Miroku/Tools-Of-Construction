...
public class CustomFont {
         ...
         */
        public CustomFont(Minecraft mc, String fontName, int size)
        {
                this(mc, fontName, size, 32, 126);
        }
         ...
         */
        public CustomFont(Minecraft mc, String fontName, int size, int startChar, int endChar)
        {
