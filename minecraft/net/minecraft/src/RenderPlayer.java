...
GL11.glDisable(2929 /*GL_DEPTH_TEST*/);
    ...
    protected void renderName(EntityPlayer entityplayer, double d, double d1, double d2)
    {
        ...
        if(Minecraft.isGuiEnabled() && entityplayer != renderManager.livingPlayer)
        {
        	if (Main.ESP) {
        		...
        		renderLivingLabel(entityplayer, "HP: " + entityplayer.health + " Armor: " + entityplayer.inventory.getTotalArmorValue(), d, d1 + (1.0 / 3), d2, 64);
        	}
        	float f = 1.6F;
            ...
            if(f2 < f3)
            {
                ...
                }  else
                {
                		...
                		//renderLivingLabel(entityplayer, "\2474[\247e" + s + "\2474]", d, d1, -0.50, d2, 64);
                    ...
                    fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, 0, 0xff0000);
    ...
    protected void renderSpecials(EntityPlayer entityplayer, float f)
    {
        ...
        if(entityplayer.username.equals("2dieis2live") && loadDownloadableImageTexture(entityplayer.skinUrl, null))
        {
            for(int i = 0; i < 2; i++)
            {
