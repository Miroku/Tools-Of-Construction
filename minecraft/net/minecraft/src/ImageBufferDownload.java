    ...
    implements ImageBuffer
{
    ...
    public BufferedImage parseUserSkin(BufferedImage bufferedimage)
    {
        ...
        if(imageHeight == 128 && imageWidth == 64)
        {
          func_884_b(0, 0, 0, 0);
          func_885_a(32, 0, 128, 64);
          func_884_b(0, 16, 0, 0);
        } else
        if(imageHeight == 256 && imageWidth == 128)
        {
          func_884_b(0, 0, 0, 0);
          func_885_a(32, 0, 256, 128);
          func_884_b(0, 16, 0, 0);
        } else
        if(imageHeight == 512 && imageWidth == 256)
        {
          func_884_b(0, 0, 32, 16);
          func_885_a(32, 0, 512, 256);
          func_884_b(0, 16, 0, 0);
        } else
        {
          func_884_b(0, 0, 32, 16);
