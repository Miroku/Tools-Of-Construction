    ...
    implements IProgressUpdate
{
    ...
    public void setLoadingProgress(int i)
    {
        ...
        if(i >= 0)
        {
            ...
            tessellator.addVertex(j1, k1 + byte0, 0.0D);
            tessellator.addVertex(j1 + c, k1 + byte0, 0.0D);
            tessellator.addVertex(j1 + c, k1, 0.0D);
            tessellator.setColorOpaque_I(0xff00cc);
            tessellator.addVertex(j1, k1, 0.0D);
            tessellator.addVertex(j1, k1 + byte0, 0.0D);
            tessellator.addVertex(j1 + i, k1 + byte0, 0.0D);
